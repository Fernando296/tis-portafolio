...
export default function RestaContra({ onSuccess, onCancel }: RestaContraProps) {
            ...
            {step === 1 ? (
                <>
                    ...
                    <form onSubmit={handleEmailSubmit}>
                        ...
                        {onCancel && (
                            <p 
                                style={{ color: 'white', textAlign: 'center', marginTop: '1.5rem', cursor: 'pointer', fontSize: '0.85rem' }}
                                onClick={onCancel}
                            >
                                Volver al login
                            </p>
